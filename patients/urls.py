...
urlpatterns = [
    ...
    path(
        "update_patient_modal/<int:id>/",
        views.update_patient_modal,
        name="update_patient_modal",
    ),
    path("update_patient/<int:id>/", views.update_patient, name="update_patient"),
    path(
        "delete_patient_modal/<int:id>/",
        views.delete_patient_modal,
        name="delete_patient_modal",
    ),
    path("delete_patient/<int:id>/", views.delete_patient, name="delete_patient"),
    path(
        "restore_patient_modal/<int:id>/",
        views.restore_patient_modal,
        name="restore_patient_modal",
    ),
