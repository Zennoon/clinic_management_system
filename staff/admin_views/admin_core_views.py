...
def admin_dashboard(request: HttpRequest):
    ...
    if request.headers.get("HX-Request"):
        return render(
            request, "staff/admin/dashboard/partials/dashboard-partial.html", context
        )
    else:
        return render(request, "staff/admin/dashboard/page.html", context)
...
def admin_dashboard_timespan(request: HttpRequest):
    ...
    return render(
        request, "staff/admin/dashboard/partials/dashboard-content.html", context
    )
...
def admin_activity_recent_visits(request: HttpRequest):
    ...
    try:
        ...
        recent_visits = paginator.page(
            paginator.num_pages if paginator.num_pages else 1
        )
    context = {"recent_visits": recent_visits}
    return render(
        request,
        "staff/admin/activity/partials/recent-visits-table-partial.html",
        context,
    )
...
def admin_activity_recent_patients(request: HttpRequest):
    ...
    try:
        ...
        recent_patients = paginator.page(
            paginator.num_pages if paginator.num_pages else 1
        )
    context = {"recent_patients": recent_patients}
    return render(
        request,
        "staff/admin/activity/partials/recent-patients-table-partial.html",
        context,
    )
...
def admin_activity_recent_lab_requests(request: HttpRequest):
    ...
    try:
        ...
        recent_lab_requests = paginator.page(
            paginator.num_pages if paginator.num_pages else 1
        )
    context = {"recent_lab_requests": recent_lab_requests}
    return render(
        request,
        "staff/admin/activity/partials/recent-lab-requests-table-partial.html",
        context,
    )
...
def admin_activity_recent_charges(request: HttpRequest):
    ...
    try:
        ...
        recent_charges = paginator.page(
            paginator.num_pages if paginator.num_pages else 1
        )
    context = {"recent_charges": recent_charges}
    return render(
        request,
        "staff/admin/activity/partials/recent-charges-table-partial.html",
        context,
    )
...
def admin_activity_recent_payments(request: HttpRequest):
    ...
    try:
        ...
        recent_payments = paginator.page(
            paginator.num_pages if paginator.num_pages else 1
        )
    context = {"recent_payments": recent_payments}
    return render(
        request,
        "staff/admin/activity/partials/recent-payments-table-partial.html",
        context,
    )
...
admin_core_urlpatterns = [
    ...
    path(
        "admin/dashboard/timespan",
        admin_dashboard_timespan,
        name="admin_dashboard_timespan",
    ),
    path("admin/activity/", admin_activity, name="admin_activity"),
    path(
        "admin/activity/recent_visits",
        admin_activity_recent_visits,
        name="admin_activity_recent_visits",
    ),
    path(
        "admin/activity/recent_patients",
        admin_activity_recent_patients,
        name="admin_activity_recent_patients",
    ),
    path(
        "admin/activity/recent_lab_requests",
        admin_activity_recent_lab_requests,
        name="admin_activity_recent_lab_requests",
    ),
    path(
        "admin/activity/recent_charges",
        admin_activity_recent_charges,
        name="admin_activity_recent_charges",
    ),
    path(
        "admin/activity/recent_payments",
        admin_activity_recent_payments,
        name="admin_activity_recent_payments",
    ),
]
